// Adjust import paths to RELATIVE, not "@/components/..."
import { Carousel, TestimonialCard } from "./retroCarousal";
import type { iTestimonial } from "./retroCarousal";

// TypeScript type for details
